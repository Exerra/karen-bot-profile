...
export let meta = (loader) => {
    ...
    return {
        ...
        "theme-color": "#EFF5FB",
        "og:image": (data.status != undefined ? "" : `https://cdn.exerra.xyz/discord/avatars/${data.id}/${data.avatar.id}`),
        "twitter:card": "summary",
        "twitter:image": (data.status != undefined ? "" : `https://cdn.exerra.xyz/discord/avatars/${data.id}/${data.avatar.id}`),
        "twitter:site": "@Exerra",
